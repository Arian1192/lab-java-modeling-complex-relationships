...
1. Using the Spring JPA model, create the relationships for an application for an model.Association of Nurses. The model.Association has 7 Chapters and each Chapter has the following properties:
